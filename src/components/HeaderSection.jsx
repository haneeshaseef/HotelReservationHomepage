    ...
    <div className="bg-black text-white p-4">
      <nav className="flex justify-between">
        <div className="flex space-x-4 gap-8">
          <button className="hover:text-gray-400 ml-12">
            ABOUT <FontAwesomeIcon icon={faChevronDown} />
          </button>
          <button className="hover:text-gray-400">
            ROOMS & SUITES <FontAwesomeIcon icon={faChevronDown} />
          </button>
          <button className="hover:text-gray-400">
            DINING <FontAwesomeIcon icon={faChevronDown} />
          </button>
          <button className="hover:text-gray-400">
          ...
          <button className="hover:text-gray-400">
            OFFERS <FontAwesomeIcon icon={faChevronDown} />
          </button>
          <button className="hover:text-gray-400">
